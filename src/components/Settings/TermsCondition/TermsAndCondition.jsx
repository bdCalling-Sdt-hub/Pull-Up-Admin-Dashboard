...
import { useCreateTermsMutation, useGetTermsQuery } from "../../../Redux/api/settingsApi";

const TermsAndCondition = () => {
    const editor = useRef(null);
    const [content, setContent] = useState("");

    const [createPrivacy] = useCreateTermsMutation();
    const { data: getTermsData } = useGetTermsQuery();
    console.log("Data", getTermsData)
